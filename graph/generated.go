...
func (ec *executionContext) field_Mutation_createMovie_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewMovie2githubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐNewMovie(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚖgithubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_movies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Movie)
	fc.Result = res
	return ec.marshalNMovie2ᚕᚖgithubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovieᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMovie2githubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖgithubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovieᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Movie) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖgithubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖgithubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewMovie2githubᚗcomᚋpaihariᚋgolangᚑgraphqlᚑcloudcontrolᚋgraphᚋmodelᚐNewMovie(ctx context.Context, v interface{}) (model.NewMovie, error) {
