...
type ComplexityRoot struct {
	...
	OCIDatabase struct {
		...
		DbHomeID       func(childComplexity int) int
		DbName         func(childComplexity int) int
		DbUniqueName   func(childComplexity int) int
		ID             func(childComplexity int) int
		KmsKeyID       func(childComplexity int) int
		LifecycleState func(childComplexity int) int
		NcharacterSet  func(childComplexity int) int
...
func (ec *executionContext) unmarshalInputNewOCIDatabase(ctx context.Context, obj interface{}) (model.NewOCIDatabase, error) {
	...
	fieldsInOrder := [...]string{"dbName", "adminPassword"}
